...
addpath(genpath('/Users/fariba/Documents/BrCprojectNewdataset/MetastaticTNBC_Modeling/Scripts'))
savepath

%% Load necessary files and data
cd /Users/fariba/Documents/BrCprojectNewdataset/MetastaticTNBC_Modeling/Data
load('HumanGEM.mat');
length(ihuman.rxns)
